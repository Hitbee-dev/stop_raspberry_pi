...
from segmentation.modules.dataloaders.utils import decode_segmap
from segmentation.modules.models.deeplab_xception import DeepLabv3_plus
...
### RUN OPTIONS ###
MODEL_PATH = "./segmentation/run/surface/deeplab/model_iou_77.pth.tar"
ORIGINAL_HEIGHT = 720
ORIGINAL_WIDTH = 1280
MODEL_HEIGHT = 512
MODEL_WIDTH = 1024
...
MODE = 'jpg'  # 'mp4' or 'jpg'
DATA_PATH = './segmentation/test/jpgs'  # .mp4 path or folder containing jpg images
OUTPUT_PATH = './segmentation/output/jpgs'  # where video file or jpg frames folder should be saved.
